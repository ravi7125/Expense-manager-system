...
<head>
    ...
    <title>{{ config('app.name', 'ravi') }}</title>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="bankname" type="bankname"
                                                class="form-control @error('bankname') is-invalid @enderror" name="bankname"
                                                placeholder="Enter Your BankName" value="{{ old('bankname') }}" required autocomplete="bankname">
                                    ...
                                    <div class="row mb-3">
                                        <label for="email"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Accountnumber') }}</label>

                                        <div class="col-md-6">
                                            <input id="accountnumber" type="accountnumber"
                                                class="form-control @error('accountnumber') is-invalid @enderror" name="accountnumber"
                                                placeholder="Enter Your AccountNumber"value="{{ old('accountnumber') }}" required autocomplete="accountnumber">
